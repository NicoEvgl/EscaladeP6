...
<body>
<!-- Full Page Intro -->
    <div class="view" style="background-image: url('/resources/img/home1.jpg'); background-repeat: no-repeat; background-size: cover; background-position: center ;">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <form:input path="password" type="password" cssClass="form-control" id="inputPassword4" placeholder="Mot de passe"
                                        minlenght="6" pattern="^(?=.{8,}$)(?=.*?[a-z])(?=.*?[A-Z])(?=.*?[0-9])(?=.*?\W).*$"
                                        title="Le mot de passe doit contenir au moins 6 caractères avec au moins 1 majuscule, 1 nombre et 1 caractère spécial" required="true"/>
