                                ...
                                <c:forEach items="${climbingSite.commentList}" var="comment">
                                    <div class="reviews">
                                        <div class="review-item">
                                            ...
                                            <span class="text-muted"><a href="<c:url value="/userProfile/${comment.user.id}"/>">${comment.user.username}</a>, <fmt:formatDate value="${comment.creationDate}" pattern="dd/MM/yyyy HH:mm:ss"/></span>
